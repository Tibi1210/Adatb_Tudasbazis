...
if (isset($_POST['login'])) {
    ...
    $adminok=$connect->prepare("SELECT * FROM ADMIN");
    $admin=$adminok->execute();

    foreach ($felhasznalok as $felhasznalo) {

        if ($felhasznalo->getEmail() === $email && $felhasznalo->getJelszo()===$password && $admin->getEmail()===$email) {
            $_SESSION["user"] = $felhasznalo;
            $_SESSION["admin"] = $felhasznalo;
