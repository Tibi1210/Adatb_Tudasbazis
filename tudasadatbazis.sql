...
Insert into HOME.CIKK (CIM,TARTALOM,LETREHOZAS_DATUM,SZERZO) values ('Macska','A macska, más néven házi macska kiseb termet? húsev? eml?s, amely a ragadozók rendjén belül a macskafélék családjának Felis neméhez és vadmacska fajához tartozik. A vadmacska alfaja.',to_date('17-JUL-19','DD-MON-RR'),'_-leo-_');
...
Insert into HOME.CIKK (CIM,TARTALOM,LETREHOZAS_DATUM,SZERZO) values ('Gersgorin-tétel','A lineáris algebrában a Gersgorin-tétel azt mondja ki, hogy a komplex test feletti négyzetes mátrix sajátértékei a komplex síkon a f?átló elemei körüli úgynevezett Gersgorin-körökön belül találhatóak. ',to_date('04-MAY-21','DD-MON-RR'),'mesi_kurucz');
Insert into HOME.CIKK (CIM,TARTALOM,LETREHOZAS_DATUM,SZERZO) values ('Himnusz','A himnusz dics?ít? és magasztaló ének. Eredetileg vallásos jelleg?, Istent vagy isteni hatalmat dics?ít?, hozzá segítségért fohászkodó, imaszer? lírai m?faj. Tárgya és alkalma tehát eredetileg valamely istenség vagy Isten dicsérete, megnyerése és magasztalása.',to_date('10-AUG-21','DD-MON-RR'),'varga__timi');
Insert into HOME.CIKK (CIM,TARTALOM,LETREHOZAS_DATUM,SZERZO) values ('Költészet','A költészet az irodalomnak m?vészeti ága. Mint az emberi lélek m?vészi tevékenysége, egyrészt a m?vészetek közé tartozik, másrészt mint irodalmi munkásság, az ember beszédm?vei közé. Törvényeit tudományos rendszerességgel a költészettan (poétika) tárgyalja. ',to_date('22-AUG-18','DD-MON-RR'),'evi_nagy');
Insert into HOME.CIKK (CIM,TARTALOM,LETREHOZAS_DATUM,SZERZO) values ('Nyelvészet','Általánosságban a nyelvészet, latinosan grammatika az emberi nyelvekkel foglalkozó tudományág, és nyelvész az, aki ezt a tudományt m?veli.',to_date('13-JUN-17','DD-MON-RR'),'-noncsi-');
...
Insert into HOME.CIKK (CIM,TARTALOM,LETREHOZAS_DATUM,SZERZO) values ('Sakktábla földterület','A sakktáblásodás olyan helyzetre utal, amikor a földtulajdon két vagy több tulajdonos között keveredik, ami sakktáblás mintázatot eredményez. Mivel a kiosztott földterületeket eltér? módon és intenzitással m?velik, a sakktábla-mintázat így a leveg?b?l is látható.',to_date('11-MAR-21','DD-MON-RR'),'*armando;)*');
Insert into HOME.CIKK (CIM,TARTALOM,LETREHOZAS_DATUM,SZERZO) values ('Present Perfect','A Present Perfect az angol nyelv egyik, a hétköznapi beszédben gyakran használt igeid?je. Jelentése: present=jelen, perfect=tökéletes, befejezett. Összetett igeid?, két tagból áll: a to have (birtokolni), mint segédige egyszer? jelen idejéb?l és a f?ige. ',to_date('06-JAN-22','DD-MON-RR'),'f.imi');
...
Insert into HOME.CIKK (CIM,TARTALOM,LETREHOZAS_DATUM,SZERZO) values ('K?olaj','A k?olaj (más néven ásványolaj) a Föld szilárd kérgében található természetes eredet?, él? szervezetek bomlásával, átalakulásával keletkezett ásványi termék. F? összetev?i folyékony halmazállapotú szénhidrogének.',to_date('31-AUG-21','DD-MON-RR'),'_cs_i_p_i_');
Insert into HOME.CIKK (CIM,TARTALOM,LETREHOZAS_DATUM,SZERZO) values ('Atomenergia','Az atomenergia a magreakció kontrollált felhasználása munka, h? és elektromosság formájú energia létrehozásának céljából. Egy irányított láncreakció után keletkezik és h?t hoz létre, amit víz felforralására, g?z el?állítására, g?zturbina meghajtására használnak.',to_date('05-MAR-21','DD-MON-RR'),'andikaa_:)_');
Insert into HOME.CIKK (CIM,TARTALOM,LETREHOZAS_DATUM,SZERZO) values ('Négyzet','A négyzet egyenl? oldalú téglalap, vagyis olyan sokszög, melynek négy egyenl? oldala és négy egyenl? szöge, mégpedig derékszöge van. Térbeli megfelel?je a kocka.',to_date('12-OCT-20','DD-MON-RR'),'_rebi_2003');
...
Insert into HOME.CIKK (CIM,TARTALOM,LETREHOZAS_DATUM,SZERZO) values ('Tulajdonnév','A tulajdonnév a f?nevek azon fajtája, amely egy konkrét egyedre utal, tehát azonosító funkciót tölt be. Fajtái: személynevek, állatnevek, tárgynevek, földrajzi nevek, intézménynevek, márkanevek... ',to_date('04-MAR-20','DD-MON-RR'),'*--lina--*');
Insert into HOME.CIKK (CIM,TARTALOM,LETREHOZAS_DATUM,SZERZO) values ('Pet?fi Sándor','Pet?fi Sándor (született Petrovics Sándor, Kisk?rös, 1823. január 1. - Fehéregyháza körül, 1849. július 31.) magyar költ?, forradalmár, nemzeti h?s, a magyar költészet egyik legismertebb és egyik legkiemelked?bb alakja.',to_date('14-JUL-20','DD-MON-RR'),'varga__timi');
Insert into HOME.CIKK (CIM,TARTALOM,LETREHOZAS_DATUM,SZERZO) values ('Kutya','A kutya vagy eb ujjon járó eml?s ragadozó állat, a szürke farkas egy már kihalt alfajának háziasított formája. Az egyetlen olyan eml?s állatfaj, amely tudományos nevében megkapta a familiaris, azaz a családhoz tartozó jelz?t. A kutyákat szokás a társállatok sorában emlegetni.',to_date('07-OCT-20','DD-MON-RR'),'evi_nagy');
...
Insert into HOME.FORRAS (CIM,HIVATKOZAS,TARTALOM) values ('Atomenergia','https://hu.wikipedia.org/wiki/Atomenergia','Az energiaellátás napjainkban, s a jöv?ben is a társadalom életének, a gazdaság fejl?désének, s az élhet? környezet fenntartásának egyik kritikus eleme lesz. A tudomány számos megoldást kínál az energiaigények kielégítésére, amelyek alkalmazásával különféle stratégiák komponálhatók meg.');
Insert into HOME.FORRAS (CIM,HIVATKOZAS,TARTALOM) values ('Sakktábla földterület','https://hu.wikipedia.org/wiki/Sakktábla_(földterület)','A sakktábla kialakulása problémákat okozhat a hozzáférés és az ökológiai gazdálkodás szempontjából. Ez az egyik f? oka a nemzeti erd?k határain belüli belterületbe vonásoknak. Ahogyan Kalifornia északnyugati részén is, a sakktáblásodás problémákhoz vezetett a nemzeti erd?területek kezelésében.');
...
Insert into HOME.FORRAS (CIM,HIVATKOZAS,TARTALOM) values ('Pitagorasz-tétel','https://hu.wikipedia.org/wiki/Pitagorasz-tétel','Manapság talán nincs olyan ember a civilizált világban, aki ne hallott volna a Pitagorasz-tétel nev? összefüggésr?l. Ez olyan alaptétel, amelyet minden iskolás gyereknek meg kell tanulnia. S?t, ez az egyike azon kevés matematikai állításnak, amelyet talán olyanok is viszonylag rendszeresen használnak, akiknek amúgy egész életükben nem sok közük van a matematikához.');
...
Insert into HOME.FORRAS (CIM,HIVATKOZAS,TARTALOM) values ('K?olaj','https://hu.wikipedia.org/wiki/K?olaj','A világszerte megnövekedett kereslet az energiahordozók iránt feler?sítette a vetélkedést az USA, az EU, Japán között. Azonban ezeknek mostanában már egy új ellenféllel kell szembenézniük, a feltörekv? Kínával. Kína egyre inkább azért küzd, hogy hozzájusson azokhoz az er?forrásokhoz, amelyek képesek szinten tartani a felszárnyaló gazdaságát.');
Insert into HOME.FORRAS (CIM,HIVATKOZAS,TARTALOM) values ('Present Perfect','https://hu.wikipedia.org/wiki/Present_Perfect','Megjegyzés: A régi angol nyelvben a mozgást kifejez? igék befejezett jelenjét nem a to have, hanem a to be igével képezték. Elvétve ma is el?fordul pl. az I have gone helyett az I am gone.');
...
Insert into HOME.FORRAS (CIM,HIVATKOZAS,TARTALOM) values ('Rendszerfejlesztés','https://hu.wikipedia.org/wiki/Számítógép-programozás','A programkészítés menetének els? lépése a feladat meghatározása, precíz "újrafogalmazása". Milyen is legyen, mit várjunk el t?le? Nézzünk meg néhány - jónak t?n? - követelményt egyel?re címszavakban!');
Insert into HOME.FORRAS (CIM,HIVATKOZAS,TARTALOM) values ('Nyelvészet','https://hu.wikipedia.org/wiki/Nyelvészet','Ebben a könyvben a nyelv grammatikáját a megszokottól eltér? módszerekkel és egy, a korábbi, bevett elméletekt?l különböz? nyelvtanmodell keretében mutatom be. A nyelvtanról két diszciplína, a nyelvészet és a kognitív pszichológia határán mozogva igyekszem majd képet alkotni.');
Insert into HOME.FORRAS (CIM,HIVATKOZAS,TARTALOM) values ('Szociológia','https://hu.wikipedia.org/wiki/Szociológia','Az 1968-ban alakított szerkeszt?bizottság intézményi háttér nélkül a fent idézett koncepció alapján a Venczel József által összeállított eredeti címszójegyzéket megpróbálta egy lexikontól m?fajánál fogva elvárható adatokkal kitölteni. Az 1970-ben alakult Kriterion Könyvkiadó intézményi gazdája lett a tervezett kiadványnak.');
Insert into HOME.FORRAS (CIM,HIVATKOZAS,TARTALOM) values ('Költészet','https://hu.wikipedia.org/wiki/Költészet','Költészet(poézis), az irodalomnak m?vészeti ága, a m?vészet, melynek közege az emberi beszéd. A K. tehát mint az emberi lélek m?vészi tevékenysége, egyrészt a m?vészetek közé tartozik, másrészt, mint irodalmi munkásság, az ember beszédm?vei közé, s reá nézve részint a m?vészetek általános törvényei, részint az irodalmi m?vek törvényei érvényesek.');
Insert into HOME.FORRAS (CIM,HIVATKOZAS,TARTALOM) values ('Madarak','https://hu.wikipedia.org/wiki/Madarak','A világon él? mintegy 10000 madárfaj közül a faj legalább egy, minden valószín?ség szerint természetes állományból származó egyede 1950. január 1. óta legalább egyszer hitelesíthet?en el?fordult Magyarország mai határain belül. ');
Insert into HOME.FORRAS (CIM,HIVATKOZAS,TARTALOM) values ('Büntet?jog','https://hu.wikipedia.org/wiki/Büntet?jog','A b?ncselekményt az elkövetése idején hatályban lev? törvény szerint kell elbírálni. Ha a cselekmény elbírálásakor hatályban lev? új büntet? törvény szerint a cselekmény már nem b?ncselekmény, vagy enyhébben bírálandó el, akkor az új törvényt kell alkalmazni; egyébként az új büntet? törvénynek nincs visszaható ereje.');
...
Insert into HOME.FORRAS (CIM,HIVATKOZAS,TARTALOM) values ('Macskafajták','https://hu.wikipedia.org/wiki/Macskafajták_listája','E törvény célja, hogy el?segítse az állatvilág egyedeinek védelmét, fokozza az emberek felel?sségtudatát az állatokkal való kíméletes bánásmód érdekében, valamint meghatározza az állatok védelmének alapvet? szabályait.');
...
Insert into HOME.FORRAS (CIM,HIVATKOZAS,TARTALOM) values ('Karl Marx','https://hu.wikipedia.org/wiki/Karl_Marx','Az 1870-es évek végén Paul Lafargue és Jules Guesde vezette fiatal szocialisták nevezték magukat els?ként marxistáknak. Marx ezt nem vette valami jó néven, mivel nézeteiket sok tekintetben epigonizmus, leegyszer?sítés, frázispufogtatás, dogmatizmus jellemezte, amit számos levelében kritizált, kigúnyolt.');
...
Insert into HOME.FORRAS (CIM,HIVATKOZAS,TARTALOM) values ('Pet?fi Sándor','https://hu.wikipedia.org/wiki/Pet?fi_Sándor','A Pet?fir?l szóló írások többsége másfél évszázada az "?szinteségét", az "egyszer?ségét", a "világosságát" emeli ki. "?szinte, mert egyszer? és nincs mit elhallgatnia. ?szinte, mint ahogy az üveg átlátszó" ? mondta Babits Mihály is, aki szerint ? olyan "tiszta és primitív tükör", "amelyen nem hagy nyomot a legfeketébb kép sem."');
Insert into HOME.FORRAS (CIM,HIVATKOZAS,TARTALOM) values ('C nyelv','https://hu.wikipedia.org/wiki/C_(programozási_nyelv)','A C típusos programnyelv. Ez azt jelenti, hogy miel?tt egy változót használni szeretnénk, deklarálnunk kell azt. Figyeljünk arra, hogy a a fordítóprogram a változónevekben is különbséget tesz a kis és a nagy bet?k között.');
...
Insert into HOME.FORRAS (CIM,HIVATKOZAS,TARTALOM) values ('Filozófia','https://hu.wikipedia.org/wiki/A_filozófia_alapkérdése','Az empiriokriticizmus (görög nyelvb?l: tapasztalatkritika) szubjektív idealista filozófiai áramlat, amely szerint a megismerés alaptörvénye a gondolkodás ökonomiája, gazdaságossága.');
...
Insert into HOME.KULCSSZO (CIM,MEGNEVEZES,LINK) values ('Büntet?jog','Jog','https://buntetojog.info/');
...
Insert into HOME.KULCSSZO (CIM,MEGNEVEZES,LINK) values ('Pet?fi Sándor','Költészet','http://magyar-irodalom.elte.hu/sulinet/igyjo/setup/portrek/petofi/petofi');
...
Insert into HOME.KULCSSZO (CIM,MEGNEVEZES,LINK) values ('K?olaj','Földrajz','https://xforest.hu/koolaj/');
...
SET DEFINE OFF;
Insert into HOME.MODOSITAS (CIM,MIKOR,FELHASZNALONEV) values ('Téglalap',to_date('10-FEB-22','DD-MON-RR'),'mesi_kurucz');
Insert into HOME.MODOSITAS (CIM,MIKOR,FELHASZNALONEV) values ('Filozófia',to_date('12-MAR-20','DD-MON-RR'),'_galambos_norbi_');
Insert into HOME.MODOSITAS (CIM,MIKOR,FELHASZNALONEV) values ('Büntet?jog',to_date('18-JUN-20','DD-MON-RR'),'marci79');
Insert into HOME.MODOSITAS (CIM,MIKOR,FELHASZNALONEV) values ('Költészet',to_date('20-MAR-21','DD-MON-RR'),'varga__timi');
Insert into HOME.MODOSITAS (CIM,MIKOR,FELHASZNALONEV) values ('Hardver',to_date('27-JAN-22','DD-MON-RR'),'g_jani__72');
Insert into HOME.MODOSITAS (CIM,MIKOR,FELHASZNALONEV) values ('Szociológia',to_date('15-JUL-20','DD-MON-RR'),'gabi_holi');
Insert into HOME.MODOSITAS (CIM,MIKOR,FELHASZNALONEV) values ('Állattenyésztés',to_date('02-FEB-22','DD-MON-RR'),'eszterrr');
Insert into HOME.MODOSITAS (CIM,MIKOR,FELHASZNALONEV) values ('Négyzet',to_date('13-AUG-21','DD-MON-RR'),'mesi_kurucz');
...
Insert into HOME.TEMAKOR (CIM,NEV,ALTEMAKOR) values ('Büntet?jog','Jog','Büntet?jog');
...
Insert into HOME.TEMAKOR (CIM,NEV,ALTEMAKOR) values ('Pet?fi Sándor','Költészet','Pet?fi Sándor');
...
Insert into HOME.TEMAKOR (CIM,NEV,ALTEMAKOR) values ('Sakktábla földterület','Agrártudomány','Földm?velés');
...
Insert into HOME.TEMAKOR (CIM,NEV,ALTEMAKOR) values ('K?olaj','Természettudomány','Földrajz');
